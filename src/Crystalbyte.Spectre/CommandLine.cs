...
namespace Crystalbyte.Spectre {
    public sealed class CommandLine : RefCountedNativeTypeAdapter {
        public CommandLine()
		...
		public CommandLine CopyDeep() {
			...
			return CommandLine.FromHandle(handle);
		}
		...
		public bool HasSwitch(string name) {
			...
			var hasSwitch = function(Handle, new StringUtf16(name).Handle);
