...
namespace Crystalbyte.Spectre.Projections
{
	...
	public static class CefBrowserCapi {
		[DllImport(CefAssembly.Name, EntryPoint = "cef_browser_host_create_browser", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
		public static extern int CefBrowserHostCreateBrowser(IntPtr windowinfo, IntPtr client, IntPtr url, IntPtr settings);
		
		[DllImport(CefAssembly.Name, EntryPoint = "cef_browser_host_create_browser_sync", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
		public static extern IntPtr CefBrowserHostCreateBrowserSync(IntPtr windowinfo, IntPtr client, IntPtr url, IntPtr settings);
	}
	...
	public static class CefBrowserCapiDelegates {
		...
		public delegate void RunFileDialogCallback(IntPtr self, CefFileDialogMode mode, IntPtr title, IntPtr defaultFileName, IntPtr acceptTypes, IntPtr callback);
	}
