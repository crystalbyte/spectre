...
namespace Crystalbyte.Spectre.Projections {
    ...
    public delegate int GetAcceleratorCallback(
        IntPtr self, int commandId, IntPtr keyCode, IntPtr shiftPressed, IntPtr ctrlPressed, IntPtr altPressed);

    public delegate int GetAcceleratorAtCallback(
        IntPtr self, int index, IntPtr keyCode, IntPtr shiftPressed, IntPtr ctrlPressed, IntPtr altPressed);
}
