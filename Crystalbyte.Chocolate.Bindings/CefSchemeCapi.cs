...
namespace Crystalbyte.Chocolate.Bindings {
    ...
    public static class CefSchemeCapi {
        [DllImport(CefAssembly.Name, EntryPoint = "cef_register_custom_scheme",
            CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern int CefRegisterCustomScheme(IntPtr schemeName, int isStandard, int isLocal,
                                                         int isDisplayIsolated);
